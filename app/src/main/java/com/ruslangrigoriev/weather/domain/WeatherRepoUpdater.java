...
public class WeatherRepoUpdater {
    ...
    public WeatherRepoUpdater(WeatherApiService weatherApiService, WeatherRepository weatherRepository) {
        this.weatherApiService = weatherApiService;
        this.weatherRepository = weatherRepository;
    }

    public void updateWeatherRepo() {
        weatherApiService.getCurrentByCity(Util.getInstance().getCityName(),lang,KEY).enqueue(new Callback<CurrentWeather>() {
            @Override
            public void onResponse(Call<CurrentWeather> call, Response<CurrentWeather> response) {
                if (response.isSuccessful()) {
                    ...
                    if (currentWeather != null) {
                        ...
                        Log.d(MY_TAG, " updater set current done");
                    } else {
            ...
            public void onFailure(Call<CurrentWeather> call, Throwable t) {
                Log.d(MY_TAG, "updater set current failure");
            }
        });

        weatherApiService.getForecastByCity(Util.getInstance().getCityName(),lang,DAYS,KEY).enqueue(new Callback<Forecast>() {
            @Override
            public void onResponse(Call<Forecast> call, Response<Forecast> response) {
                if (response.isSuccessful()) {
                    ...
                    if (forecast != null) {
                        ...
                        Log.d(MY_TAG, " updater set forecast done");
                    } else {
                        Toast.makeText(App.getInstance().getApplicationContext(), "Wrong city name", Toast.LENGTH_SHORT).show();
                    }
                }
